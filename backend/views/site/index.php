                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?= Url::to(['home/info', 'id' => $id], true) ?>" tppabs="<?= Url::to(['home/info', 'id' => $id], true) ?>">统计</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="<?= Url::to(['system/employee', 'id' => $id], true) ?>" tppabs="<?= Url::to(['system/employee', 'id' => $id], true) ?>">公司员工</a>
                            </li>
                            <li><a class="J_menuItem" href="<?= Url::to(['system/project', 'id' => $id], true) ?>" tppabs="<?= Url::to(['system/project', 'id' => $id], true) ?>">项目</a>
                            </li>
                          
                            <li><a class="J_menuItem" href="<?= Url::to(['system/team', 'id' => $id], true) ?>" tppabs="<?= Url::to(['system/team', 'id' => $id], true) ?>">团队管理</a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="<?= Url::to(['system/blog', 'id' => $id], true) ?>" tppabs="<?= Url::to(['system/blog', 'id' => $id], true) ?>">文章列表</a>
                                    </li>
                                    <li><a class="J_menuItem" href="<?= Url::to(['system/blogDetail', 'id' => $id], true) ?>" tppabs="<?= Url::to(['system/blogDetail', 'id' => $id], true) ?>">文章详情</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="hidden-xs">
                            <a href="<?= Url::to(['home/index', 'id' => $id], true) ?>" tppabs="<?= Url::to(['home/index', 'id' => $id], true) ?>" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                        </li>
