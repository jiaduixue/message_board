...
<div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="img/qr_code.png" tppabs="http://www.zi-han.net/theme/hplus/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
            ...
            <br>
            <p>
                <a class="btn btn-success btn-outline" href="javascript:if(confirm(%27http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes%27" tppabs="http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes" target="_blank">
                    <i class="fa fa-qq"> </i> 联系我
                </a>
                <a class="btn btn-white btn-bitbucket" href="javascript:if(confirm(%27http://www.zi-han.net/  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://www.zi-han.net/%27" tppabs="http://www.zi-han.net/" target="_blank">
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <p><i class="fa fa-send-o"></i> 博客：<a href="javascript:if(confirm(%27http://www.zi-han.net/  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://www.zi-han.net/%27" tppabs="http://www.zi-han.net/" target="_blank">http://www.zi-han.net</a>
                        </p>
                        <p><i class="fa fa-qq"></i> QQ：<a href="javascript:if(confirm(%27http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes%27" tppabs="http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes" target="_blank">516477188</a>
                        </p>
                            ...
                            <div class="panel-group" id="version">
                                    ...
                                    <div id="v20" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                ...
                                                <li>增加上下布局； <a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/index_4.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>在360浏览器6.0以上版本中强制以webkit内核解析，体验更佳；
                                                </li>
                                                <li>增加<a href="toastr_notifications.html" tppabs="http://www.zi-han.net/theme/hplus/toastr_notifications.html">Toastr通知</a>、<a href="nestable_list.html" tppabs="http://www.zi-han.net/theme/hplus/nestable_list.html">嵌套列表</a>、<a href="timeline_v2.html" tppabs="http://www.zi-han.net/theme/hplus/timeline_v2.html">时间轴</a>、<a href="forum_main.html" tppabs="http://www.zi-han.net/theme/hplus/forum_main.html">论坛</a>、<a href="code_editor.html" tppabs="http://www.zi-han.net/theme/hplus/code_editor.html">代码编辑器</a>、<a href="modal_window.html" tppabs="http://www.zi-han.net/theme/hplus/modal_window.html">模态窗口</a>、<a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/validation.html">表单验证</a>、<a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/tree_view_v2.html">树形视图</a>、<a href="chat_view.html" tppabs="http://www.zi-han.net/theme/hplus/chat_view.html">聊天窗口</a>等页面；
                                                </li>
                                                <li>升级<a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/icons.html">Font Awesome</a>，<a href="form_simditor.html" tppabs="http://www.zi-han.net/theme/hplus/form_simditor.html">Simditor</a>等到最新版本；
                                                </li>
                                                <li>优化部分内容
                                                </li>
                                    ...
                                    <div id="v18" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                ...
                                                <li>修复了WebUploader中的一些问题； <a href="form_webuploader.html" tppabs="http://www.zi-han.net/theme/hplus/form_webuploader.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                            </ol>
                                        </div>
                                    </div>
                                    ...
                                    <div id="v17" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                ...
                                                <li>增加jqGrid组件； <a href="table_jqgrid.html" tppabs="http://www.zi-han.net/theme/hplus/table_jqgrid.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>修复Summernote编辑器中的一个严重错误； <a href="form_editors.html" tppabs="http://www.zi-han.net/theme/hplus/form_editors.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                    ...
                                    <div id="v16" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                ...
                                                <li>增加Markdown编辑器 <a href="form_markdown.html" tppabs="http://www.zi-han.net/theme/hplus/form_markdown.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>增加拾色器ColorPicker <a href="form_advanced.html" tppabs="http://www.zi-han.net/theme/hplus/form_advanced.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>优化部分页面代码
                                                </li>
                                            </ol>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v15" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                <li>增加了Bootstrap3表单构建器，表单设计更轻松； <a href="form_builder.html" tppabs="http://www.zi-han.net/theme/hplus/form_builder.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>修改了webim的高度；
                                                </li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v14" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                <li>修复了百度ECharts图表显示不正确的问题； <a href="graph_echarts.html" tppabs="http://www.zi-han.net/theme/hplus/graph_echarts.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>新增表单验证示例，使用jQuery Validate插件实现； <a href="form_validate.html" tppabs="http://www.zi-han.net/theme/hplus/form_validate.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>新增树形视图示例； <a href="tree_view.html" tppabs="http://www.zi-han.net/theme/hplus/tree_view.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>修复弹框遮罩的Bug；
                                                </li>
                                            </ol>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v13" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                <li>加入阿里巴巴团队的字体图标库，字体图标可以自定义啦； <a href="iconfont.html" tppabs="http://www.zi-han.net/theme/hplus/iconfont.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>新增头像裁剪上传组件FullAvatareditor； <a href="form_avatar.html" tppabs="http://www.zi-han.net/theme/hplus/form_avatar.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>集成网页弹层插件layer； <a href="layer.html" tppabs="http://www.zi-han.net/theme/hplus/layer.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>集成日期选择器layerDate； <a href="layerdate.html" tppabs="http://www.zi-han.net/theme/hplus/layerdate.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li class="text-danger"><b>增加web即时通讯功能，可以在系统内在线聊天了；</b> <a href="webim.html" tppabs="http://www.zi-han.net/theme/hplus/webim.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v12" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                <li>新增百度WebUploader拖动上传文件组件；<a href="form_webuploader.html" tppabs="http://www.zi-han.net/theme/hplus/form_webuploader.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>新增国产优秀富文本编辑器插件Simditor；<a href="form_simditor.html" tppabs="http://www.zi-han.net/theme/hplus/form_simditor.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>新增百度ECharts统计图表插件；<a href="form_simditor.html" tppabs="http://www.zi-han.net/theme/hplus/form_simditor.html" title="去看看"><i class="fa fa-eye"></i></a>
                                                </li>
                                                <li>修复了几处问题。</li>
                                            </ol>
                                        </div>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <hr>
                        <p>如果需要购买H+主题，可直接付款到支付宝：<a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/javascript;">zheng-zihan@qq.com</a>，收款人：<a href="../../error/ie.html" tppabs="http://www.zi-han.net/theme/hplus/javascript;">*子涵</a>。也可以使用手机支付宝或者微信扫码支付：</p>
                        <div class="alert alert-warning">
                            付款完成后请及时联系作者，或在付款备注中留下邮箱或QQ，方便作者及时联系您。
                            <br>如果图片太小，可以点击图片放大。
                        </div>
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="../../../cdn.zi-han.net/theme/hplus/pay.png-922.png" tppabs="http://cdn.zi-han.net/theme/hplus/pay.png?922" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
